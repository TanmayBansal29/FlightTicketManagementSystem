...
public class BookingController {
    ...
    public void addFlight() {
        ...
        System.out.println("Enter the timing of Departure in format: yyyy-MM-dd HH:mm");
    ...
    public void cancelTicket() {
        ...
        System.out.println(
                "------------------------------------------------------------------------------------------------------------------------------");
        int d = getFlightIndexById(ticketList.get(index - 1).flight.getId());
        Ticket deleted = ticketList.remove(index - 1);
    ...
    public void deleteFlight() {
        ...
        System.out.println(
                "------------------------------------------------------------------------------------------------------------------------------");
        Flight deleted = flightList.remove(index - 1);
        System.out.println("                                                -------------------------------------");
